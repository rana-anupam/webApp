angular.module('hocketWebsite')
     .controller('single_door_refrigerator_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("single_door_refrigerator controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/appliances/single_door_refrigerator/single_door_refrigerator.jpg';
       	...
       	$('.bannerImage').attr("src",$scope.bannerImageSrc);
            ...
            $scope.productId = 'RSD01';

            $scope.tarrif_rate = [0,1250,900,783,725,690,666,650,637,627,620,613,608,603,600,596,593,591,589];            
