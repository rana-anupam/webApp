angular.module('hocketWebsite')
     .controller('front_load_wm_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("front_load_wm_Controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/appliances/front_load_wm/front_load_wm.jpg';
       	...
       	$('.bannerImage').attr("src",$scope.bannerImageSrc);
            ...
            $scope.productId = 'WMF01';

            $scope.tarrif_rate = [0,1280,930,814,755,720,697,680,667,658,650,644,639,634,630,627,624,622,619];
