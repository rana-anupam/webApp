angular.module('hocketWebsite')
     .controller('top_load_wm_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("top_load_wm controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/appliances/top_load_wm/top_load_wm.jpg';
       	...
       	$('.bannerImage').attr("src",$scope.bannerImageSrc);
            ...
            $scope.productId = 'WMT01';

            $scope.tarrif_rate = [0,1200,850,733,675,640,616,600,587,577,570,563,558,583,550,546,543,541,539];
