angular.module('hocketWebsite')
     .controller('Myrilux_2BHK_Combo_C_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("Myrilux_2BHK_Combo_C_Controller controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/combos/images/2BHK/7.png';
            ...
            $scope.tarrif_rate = [0,3850,3450,3317,3250,3210,3183,3164,3150,3139,3130,3123,3117,3112,3107,3103,3100,3097,3095];
            $scope.itemsIncluded = "4 Core + 8 Addon items";
            $scope.securityDeposit = 3500;
            $scope.productId = 'CAF2BMC';
            if(package == 'basic'){
            ...
            var time = moment().add({hours:5,minutes:30}).format('MMMM Do YYYY , h:mm:ss a');
                  if($scope.user.loggedIn){
                        ...
                        var request = {               userId : $scope.user.id,
                                                            ...
                                                            productName: 'Myrilux 2BHK Combo - C',
