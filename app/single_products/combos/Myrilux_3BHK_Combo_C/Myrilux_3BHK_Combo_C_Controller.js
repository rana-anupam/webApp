angular.module('hocketWebsite')
     .controller('Myrilux_3BHK_Combo_C_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("Myrilux_3BHK_Combo_C_Controller controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/combos/images/3BHK/7.png';
            ...
            $scope.tarrif_rate = [0,4785,4335,4185,4110,4065,4035,4014,3998,3985,3975,3967,3960,3954,3949,3945,3941,3938,3935];
            $scope.itemsIncluded = "5 Core + 12 Addon items";
            $scope.securityDeposit = 4400;
            $scope.productId = 'CAF3BMC';
            if(package == 'basic'){
            ...
            var time = moment().add({hours:5,minutes:30}).format('MMMM Do YYYY , h:mm:ss a');
                  if($scope.user.loggedIn){
                        ...
                        var request = {               userId : $scope.user.id,
                                                            ...
                                                            productName: 'Myrilux 3BHK Combo - C',
