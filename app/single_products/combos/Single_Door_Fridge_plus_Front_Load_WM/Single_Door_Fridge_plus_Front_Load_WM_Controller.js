angular.module('hocketWebsite')
     .controller('Single_Door_Fridge_plus_Front_Load_WM_Controller', ['$scope','$state','$http', function($scope, $state,$http){
       console.log("Single_Door_Fridge_plus_Front_Load_WM_Controller controller is loading");
       ...
       $scope.activePackage = function(package){
        ...
        $scope.bannerImageSrc = './app/single_products/combos/images/Appliances/4.png';
       	...
       	$('.bannerImage').attr("src",$scope.bannerImageSrc);
            ...
            $scope.productId = 'CA04';
            $scope.tarrif_rate = [0,1830,1480,1364,1305,1270,1247,1230,1217,1208,1200,1194,1189,1184,1180,1177,1174,1172,1169]; 
       	...
       	var time = moment().add({hours:5,minutes:30}).format('MMMM Do YYYY , h:mm:ss a');
       		if($scope.user.loggedIn){
       			...
       			var request = {			userId : $scope.user.id,
		   								...
		   								productName: 'Single Door Refrigerator + Front Load Washine Machine',
