angular.module('hocketWebsite')
     .controller('furnitureController', ['$scope','$state','$http', "$stateParams","$rootScope", function($scope, $state ,$http, $stateParams, $rootScope){
...
$http.post('auth/user')
      ...
      function myTimer() {
            ...
            for(i=0;i<$scope.webPageData.productIncluded.furniture.length;i++){
                  var temp = $scope.webPageData.productIncluded.furniture[i];
