       ...
       $http.post('auth/user')
		...
		$scope.applyPromo = function(){
			...
			if($scope.promoCode != undefined){
				...
				else if( $scope.promoCode == 'AKASH32'){
					if($scope.cartSummaryRent < 500){
						$scope.promocodeText = 'To apply this code minimum monthly rent should be Rs.500';
						$scope.promocodeTextColor = 'red';
					}
					else{						
					console.log("Apply AKASH32");
					$scope.cartSummaryDiscount = Math.ceil($scope.cartSummaryRent * 0.32);
					$scope.promocodeText = 'Congratulations! you have received 32% off on your monthly rent';
					$scope.promocodeTextColor = 'green';
					$scope.updateCartSummary();
					}
				}

				else if( $scope.promoCode == 'PRAKHAR25'){
					if($scope.cartSummaryRent < 500){
						$scope.promocodeText = 'To apply this code minimum monthly rent should be Rs.500';
						$scope.promocodeTextColor = 'red';
					}
					else{						
					console.log("Apply PRAKHAR25");
				...
				else if( $scope.promoCode == 'NITESH20'){
					if($scope.cartSummaryRent < 1000){
						$scope.promocodeText = 'To apply this code minimum monthly rent should be Rs.1000';
						$scope.promocodeTextColor = 'red';
					}
					else{						
					console.log("Apply NITESH20");
					$scope.cartSummaryDiscount = Math.ceil($scope.cartSummaryRent * 0.20);
					$scope.promocodeText = 'Congratulations! you have received 20% off on your monthly rent';
					$scope.promocodeTextColor = 'green';
					$scope.updateCartSummary();
					}
